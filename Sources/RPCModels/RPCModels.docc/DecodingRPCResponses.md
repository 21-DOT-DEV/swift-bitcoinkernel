...
Work with RPCModels types to decode Bitcoin Core JSON-RPC responses.

## How Models Map to RPC Methods

Each struct in RPCModels corresponds to a specific Bitcoin Core RPC method's response. The struct's doc comment names the source method:
