...
| 2 | Daemon API | COMPLETE | [phase-2-daemon-api.md](phase-2-daemon-api.md) |
| 3 | RPC Client + Wallet RPC | COMPLETE | [phase-3-rpc-client.md](phase-3-rpc-client.md) |
| 4 | P2P Networking | NEXT UP | [phase-4-p2p-networking.md](phase-4-p2p-networking.md) |
| 5 | Compact Block Filters | PLANNED | [phase-5-compact-filters.md](phase-5-compact-filters.md) |
| 6 | Advanced P2P | FUTURE | [phase-6-advanced-p2p.md](phase-6-advanced-p2p.md) |
| 7 | Lightning Integration | FUTURE | [phase-7-lightning-integration.md](phase-7-lightning-integration.md) |
| 8 | RPC Server & Privacy | FUTURE | [phase-8-rpc-server.md](phase-8-rpc-server.md) |
| 9 | Distribution & Release Artifacts | PLANNED | [phase-9-distribution.md](phase-9-distribution.md) |
| 10 | Vendir Migration | PLANNED | [phase-10-vendir-migration.md](phase-10-vendir-migration.md) |
