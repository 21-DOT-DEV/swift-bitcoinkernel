...
> Supersedes ADR 0007. That record governs how the action decides when to stop; this
> one governs whether it stops at all.

> Status note: recovered from an earlier implementation. The node-survival figures
> below were measured there; they must be re-taken with the screen locked on the
> shipped code before this record can be accepted.
