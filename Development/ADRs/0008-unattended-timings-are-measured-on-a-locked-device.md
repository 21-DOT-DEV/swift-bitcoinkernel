...
> Status note: recovered from an earlier implementation. The locked-versus-unlocked
> figures below were measured there; they must be re-taken with the screen locked on
> the shipped code before this record can be accepted.
